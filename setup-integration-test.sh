#!/bin/bash
echo "Building PostgreSQL Integration Test..."

cat << 'EOF' > src/test/java/com/station/spaceship/controller/SpaceshipIntegrationTest.java
...
echo "Integration Test generated successfully!"
